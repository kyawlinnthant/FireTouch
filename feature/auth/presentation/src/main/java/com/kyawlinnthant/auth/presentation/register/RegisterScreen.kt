...
import com.kyawlinnthant.auth.presentation.common.ImageSize
import com.kyawlinnthant.auth.presentation.common.asSize
import com.kyawlinnthant.auth.presentation.common.getTmpFileUri
        ...
        rememberLauncherForActivityResult(contract = ActivityResultContracts.TakePicture()) { isSuccess ->
            if (isSuccess) {
                tmpUri?.let { uri ->
                    ...
                    if (bmpSize >= com.kyawlinnthant.common.Constant.IMAGE_SIZE_LIMIT) {
                        scope.launch {
                            snackState.showSnackbar(
                                "Selected photo's size is larger than ${com.kyawlinnthant.common.Constant.IMAGE_SIZE_LIMIT} MB"
                            )
                        }
